...
- (void)setScrollView:(UIScrollView *)scrollView
{
    ...
    // 1.设置边框
    self.frame = CGRectMake(0, - MJRefreshViewHeight - 175.0 / kAutoWidth, scrollView.frame.size.width, MJRefreshViewHeight);
	...
	switch (state) {
		case MJRefreshStatePulling: // 松开可立即刷新
        {
            ...
            [UIView animateWithDuration:MJRefreshAnimationDuration animations:^{
                ...
                CGPoint arrowF = _arrowImage.center;
                CGPoint viewF = _activityView.center;
                arrowF.y  = center.y;
                viewF.y = center.y;
                _arrowImage.center = arrowF;
                _activityView.center = viewF;
